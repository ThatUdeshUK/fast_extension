...
class KNNQueryTest {
    ...
    @Test
    void pushUntilK() {
        KNNQuery dummyQuery = new KNNQuery(0, List.of("k1", "k2"), new Point(5, 5), 3, null, 100);

        List<DataObject> objects = List.of(
                new DataObject(0, new Point(5, 6), List.of("k1", "k2"), 100),
                new DataObject(1, new Point(7, 6), List.of("k1", "k2"), 100),
                new DataObject(2, new Point(1, 1), List.of("k1", "k2"), 100),
                new DataObject(3, new Point(4, 5), List.of("k1", "k2"), 100)
        );
    ...
    void calcMinSpatialLevel() {
        ...
        KNNQuery dummyQuery = new KNNQuery(0, List.of("k1", "k2"), new Point(192, 192), 3, null, 100);

        List<DataObject> objects = List.of(
                new DataObject(0, new Point(128, 128), List.of("k1", "k2"), 100),
                new DataObject(1, new Point(200, 210), List.of("k1", "k2"), 100),
                new DataObject(2, new Point(192, 384), List.of("k1", "k2"), 100),
                new DataObject(3, new Point(4, 5), List.of("k1", "k2"), 100)
        );
