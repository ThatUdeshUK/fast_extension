...
class FASTHybridTest {
    ...
    public FASTHybridTest() {
        this.queries = L.of(
                ...
                new KNNQuery(12, L.of("k1", "k2"), new Point(5.0, 5.0), 3, null,0, 100),
                new KNNQuery(14, L.of("k1", "k2"), new Point(7.0, 7.0), 2, null, 0, 100)
        );
        ...
        this.answers = L.of(
                new Answer(1, 2, 3, 8, 12, 14),
                new Answer(1, 2, 3, 8, 12, 14),
                new Answer(1, 2, 3, 8, 12),
                new Answer(1, 2, 3, 8),
                new Answer(1, 2, 3, 8, 12, 14)
        );
    }
