...
class FASTTest {
    ...
    public FASTTest() {
        ...
        this.objects = List.of(
                new DataObject(1, new Point(8.0, 4.0), List.of("k3", "k6"), 1),
                new DataObject(2, new Point(2.0, 6.0), List.of("k1", "k2"), 2),
                new DataObject(3, new Point(8.0, 2.0), List.of("k1", "k3"), 3),
                new DataObject(4, new Point(0.0, 2.0), List.of("k1", "k3"), 4),
                new DataObject(5, new Point(7.0, 8.0), List.of("k1", "k3"), 5)
        );
