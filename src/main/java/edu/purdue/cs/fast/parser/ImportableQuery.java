...
public class ImportableQuery {
	...
	public ImportableQuery(ImportableQuery q){
		added=false;
		visitied = 0;
		this.farthestDistance = maxFarthestDistance;
		...
		this.setSpatialRange(new Rectangle(q.spatialRange.min,q.spatialRange.max));
	...
	public String toString(){
		String output = "ImportableQuery[: "+(getQueryId()==null?"":getQueryId())
