...
//    }
    ...
    //
    //		 LatLong latlong = new LatLong();
    //		 latlong.setLatitude((xy.x/SpatioTextualConstants.xMaxRange*180)-90);
    //		 latlong.setLongitude((xy.y/SpatioTextualConstants.yMaxRange*360)-180);
    //
    //         return latlong;
    //	}
...
//    }
    ...
    //	}
    public static Boolean overlapsSpatially(Point point, Rectangle rectangle) {
        return Double.compare(point.x, rectangle.min.x) >= 0 && Double.compare(point.x, rectangle.max.x) <= 0 && Double.compare(point.y, rectangle.min.y) >= 0
    ...
    public static Boolean overlapsSpatially(Rectangle rectangle1, Rectangle rectangle2) {
        return (rectangle1.min.x <= rectangle2.max.x || Math.abs(rectangle1.min.x - rectangle2.max.x) < .000001)
    ...
    public static Boolean coversSpatially(Rectangle rectangle1, Rectangle rectangle2) {
        return (rectangle1.min.x <= rectangle2.min.x || Math.abs(rectangle1.min.x - rectangle2.min.x) < .000001)
                ...
                && (rectangle1.min.y <= rectangle2.min.y || Math.abs(rectangle1.min.y - rectangle2.min.y) < .000001)
